  ...
  return (
    <div style={{ minHeight: '100vh', display: 'grid', placeItems: 'center', padding: 20 }}>
      <form onSubmit={submit} style={{ width: 380, background: '#fff', border: '1px solid #e7e7e7', borderRadius: 14, padding: 58 }}>
        ...
        <label style={{ display: 'block', fontSize: 12, color: '#666', marginBottom: 6 }}>Login</label>
        <input
          value={login}
        ...
        <input
          ...
          placeholder="admin"
          style={{ width: '100%', padding: 10, borderRadius: 10, border: '1px solid #ddd', marginBottom: 14 }}
        />
